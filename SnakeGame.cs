...
namespace Znake
{
    ...
    class SnakeGame
    {
        internal const int AppleSize = 15;
        internal int appleEaten = 0;
        ...
        {
            if (NewDirection == Direction.UP && CurrentDirection == Direction.DOWN)//illegal
                return;
            if (NewDirection == Direction.DOWN && CurrentDirection == Direction.UP)//illegal
                return;
            if (NewDirection == Direction.LEFT && CurrentDirection == Direction.RIGHT)//illegal
                return;
            if (NewDirection == Direction.RIGHT && CurrentDirection == Direction.LEFT)//illegal
                return;
